...
import CustomUploadFile from "@/components/organisms/CustomUpload";
import FieldInput from "@/components/organisms/FieldInput";
import InputSkill from "@/components/organisms/InputSkills";
...
import { overviewFormSchema } from "@/lib/formSchema";
    ...
    <div>
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-7">
          ...
          >
            <CustomUploadFile form={form} name="image" />
          </FieldInput>
          <FieldInput
            title="Company Details"
            subTitle="Introduce your company core info quickly to users by fill up company detail"
          >
